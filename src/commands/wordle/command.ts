    ...
    const data = new SlashCommandBuilder()
        ...
        .addSubcommand((subcommand) =>
            subcommand
                ...
                .setDescription("다양한 Wordle 기록을 표시합니다."),
        );
...
export async function runWordleRecords(interaction: WordleInteraction): Promise<void> {
        ...
        execute: async (interaction) => {
            ...
            switch (subcommand) {
                ...
                case WORDLE_RECORDS_SUBCOMMAND_NAME:
                    return runWordleRecords(interaction);
