...
import type { WordleDictionary } from "../../application/ports.js";

const FIVE_LETTER_WORD_PATTERN = /^[a-z]{5}$/u;
const WORD_DATASET_URL = new URL(
    "../../../../../assets/valid-five-letter-words.json",
    import.meta.url,
);
...
export class LocalDictionary implements WordleDictionary {
    private readonly words = loadFiveLetterEnglishWords();
