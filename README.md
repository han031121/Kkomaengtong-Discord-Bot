...
- `/워들 [단어:<5글자 영단어>]`: 오늘의 NYT Wordle을 시작하거나 선택한 단어를 바로 제출
    ...
    - 날짜별 퍼즐 정답은 한 번만 저장하고, 새 퍼즐이 확인되면 당일과 바로 전날의 게임·참여·현황 기록만 유지
