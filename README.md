...
- `/워들`: Wordle 기능을 다음 서브커맨드로 제공
    ...
    - `/워들 기록 개인 [사용자]`: 본인 또는 선택한 사용자의 Wordle 성공·연속 성공·정답률·평균 시도·스포일러·사전 미등록 입력 기록 표시
    - `/워들 기록 전체`: 현재 서버 기록 보유자의 연속 성공·정답률·평균 시도 횟수 순위를 항목별 최대 5위까지 표시하며 기존 전체 기록 메시지를 교체
    - 게임 동작
